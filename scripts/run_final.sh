...
#   bash scripts/run_final.sh configs/final.yaml
#   bash scripts/run_final.sh configs/final.yaml fog
#   CONDITION=fog bash scripts/run_final.sh
#
...
#   outputs/logs/final_fog_YYYYMMDD_HHMMSS.log
#   outputs/results/final_fog/
#   outputs/visualizations/final_fog/
#   outputs/analysis/final_fog/

CONFIG_PATH="${1:-configs/final.yaml}"
...
if [[ -n "${CONDITION}" ]]; then
  EXPERIMENT_NAME="final_${CONDITION}"
else
...
save_dir = ckpt_cfg.get("save_dir", "outputs/checkpoints/final")
...
echo "Starting final pipeline with nohup..."
...
echo ""
echo "============================================================"
echo "[5/5] Plotting final results"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "final pipeline finished successfully."
