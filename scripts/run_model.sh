...
#   bash scripts/run_model.sh configs/proposed.yaml
#   bash scripts/run_model.sh configs/proposed.yaml fog
#   CONDITION=fog bash scripts/run_model.sh
#   CONFIG_DIR=configs/model bash scripts/run_model.sh
#   EXPERIMENTS="unet segformer" bash scripts/run_model.sh
#
# This script runs model experiments sequentially.
# Each experiment config in configs/model/ is treated as an override config.
...
#
# Output structure:
#   outputs/logs/model_YYYYMMDD_HHMMSS.log
#   outputs/results/model/<experiment>/
#   outputs/visualizations/model/<experiment>/
#   outputs/analysis/model/<experiment>/
#   outputs/checkpoints/model/<experiment>/
...
GROUP="model"
CONFIG_DIR="${CONFIG_DIR:-configs/model}"
